...
from .views import CheckResetPasswordView, RegisterView, MyTokenObtainPairView, ResetPasswordView, ForgotPasswordCheckView, ForgotPasswordConfirmView, ForgotPasswordSerializer, UserMeView, UserUpdateView
